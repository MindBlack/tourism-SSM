                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                <td>${prodect.id}</td>
                                <td>${prodect.productNum}</td>
                                <td>${prodect.productName}</td>
                                <td>${prodect.cityName}</td>
                                <td>${prodect.departureTimeStr}</td>
                                <td class="text-center">${prodect.productPrice}</td>
                                <td>${prodect.productDesc}</td>
                                <td class="text-center">${prodect.productStatusStr}</td>
